...
final class Crypt
{
     ...
     * @see encryptByKey()
     */
    public function encryptByPassword(string $data, #[\SensitiveParameter] string $password): string
    {
     ...
     */
    public function encryptByKey(string $data, #[\SensitiveParameter] string $inputKey, string $info = ''): string
    {
     ...
     * @see encryptByPassword()
     */
    public function decryptByPassword(string $data, #[\SensitiveParameter] string $password): string
    {
     ...
     * @see encryptByKey()
     */
    public function decryptByKey(string $data, #[\SensitiveParameter] string $inputKey, string $info = ''): string
    {
     ...
     * @see decrypt()
     */
    private function encrypt(string $data, bool $passwordBased, #[\SensitiveParameter] string $secret, string $info = ''): string
    {
     ...
     * @see encrypt()
     */
    private function decrypt(string $data, bool $passwordBased, #[\SensitiveParameter] string $secret, string $info): string
    {
        [$blockSize, $keySize] = self::ALLOWED_CIPHERS[$this->cipher];
